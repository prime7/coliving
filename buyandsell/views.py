...
def ApplicationAcceptView(request, postingpk, offerpk):
    ...
    if request.user:
        ...
        offer.applicant.email_user(
            ...
            message=f"{request.user} has accepted your offer of ${offer.offering_price} for their posting! Head to https://incuman.com/dashboard/chats/ to coordinate the rental process with them!",
        )
